...
#include "madgwick_filter_6axis_imu.h"
...
float yawAngleDriftBias = 0.0;
float randomGainMultiplier = 1.0;
float yawWithDrift = 0.0;
/*-----------------------------------------*/
